    ...
    <div className="min-h-screen bg-background">
      <aside className="fixed inset-y-0 left-0 w-64 border-r border-border bg-card/50 hidden md:block">
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 p-4"><Link href="/admin" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm hover:bg-secondary"><LayoutDashboard className="w-4 h-4" />Sessions</Link></nav>
